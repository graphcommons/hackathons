...
- Using Ruby Wrapper for Graph Commons API: [https://github.com/graphcommons/graphcommons-ruby](https://github.com/graphcommons/graphcommons-ruby){:target="_blank"}
...
- Using PHP7 Wrapper for Graph Commons API: [https://github.com/graphcommons/graphcommons-php7](https://github.com/graphcommons/graphcommons-php7){:target="_blank"}
...
- Data source: [kap.gov.tr](http://www.kap.gov.tr/sirketler/islem-goren-sirketler/tum-sirketler.aspx){:target="_blank"} for all the public companies listed in the stock exchange.
- Using Node.js Wrapper for Graph Commons API: [https://github.com/igaln/graphcommons-node](https://github.com/igaln/graphcommons-node){:target="_blank"}
